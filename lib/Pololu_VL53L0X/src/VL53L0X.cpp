...
#define ADDRESS_DEFAULT 0x29 //0b0101001
...
bool VL53L0X::init(bool io_2v8)
{
  ...
  writeReg(SYSTEM_INTERRUPT_CONFIG_GPIO, 0x04); // GPIO1 as INT output
  writeReg(GPIO_HV_MUX_ACTIVE_HIGH, readReg(GPIO_HV_MUX_ACTIVE_HIGH) & ~0x10); // active low
  writeReg(SYSTEM_INTERRUPT_CLEAR, 0x01); // clear interrupt flag
